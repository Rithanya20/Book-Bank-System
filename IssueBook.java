...
public class IssueBook extends javax.swing.JFrame {
   ...
   SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd");
    String  checkAvailability,SName,Address,SStream,SClass,bStream,bClass;
    /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(t2.getText().equals("")) 
            JOptionPane.showMessageDialog(this,"Get Yourself Registered!");
        else
        {
                try
                    {
                        ...
                        rs.next();
                        bStream=rs.getString("Stream");
                         bClass=rs.getString("Class");
                        if(t6.getText().equals("YES"))
                        {
                            query="insert into issue values('"+t1.getText()+"','"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+"','"+Address+"','"+t5.getText()+"','"+bStream+"','"+bClass+"');";
    ...
    public void connect()
    {
        ...
        {  
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/lib","root","rithanya");
